...
![IGEAT logo](reference/figures/logo_old.png)

`gravitR` implements gravity-based allocation models using the Furness
convergence algorithm to estimate interactions between demand locations
and service providers. The package is particularly suited to the study
of accessibility to public services and collective amenities, including
childcare, education, healthcare, and sports facilities.

By combining distance-decay effects with capacity constraints and
competition between users, `gravitR` produces accessibility indicators
that can be used to measure spatial inequalities in access to services
and facilities. These indicators reflect both proximity and service
saturation, providing a more realistic assessment of territorial equity
...
[![IGEAT
logo](reference/figures/logo_ulb_igeat.png)](https://gag.sciences.ulb.be/)
...
[![PhacochR
logo](reference/figures/logo_phacochr.png)](https://phacochr.github.io/phacochr)
