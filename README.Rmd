...
```{r ratio-map, echo=TRUE, message=FALSE, warning=FALSE, fig.path="man/figures/", fig.width=8, fig.height=6}
...
```{r gravity-map, echo=TRUE, message=FALSE, warning=FALSE, fig.path="man/figures/", fig.width=8, fig.height=6}
