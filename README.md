...
![](man/figures/README-ratio-map-1.png)<!-- -->
...
where $S_i$ is the supply, $D_j$ is the demand, and $d_{ij}$ is the
distance between demand and supply locations.
...
![](man/figures/README-gravity-map-1.png)<!-- -->
